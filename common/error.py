...
SERVER_ERR_OBJECT_NOT_EXIST = 10004
SERVER_ERR_OP_CONCURRENT = 10005

SERVER_ERR_FI_ALREADY_EXIST = 30001
SERVER_ERR_FI_NOT_EXIST = 30002

SERVER_ERR_FS_ALREADY_EXIST = 40001
SERVER_ERR_FS_NOT_EXIST = 40002
...
SERVER_ERR_DICT = {
    ...
    SERVER_ERR_OBJECT_NOT_EXIST: 'object not exist',
    SERVER_ERR_OP_CONCURRENT: 'operation must not be concurrent',
